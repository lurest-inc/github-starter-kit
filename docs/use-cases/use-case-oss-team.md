...
<li><a href="#-github-projects-%E3%81%8C-oss%E3%83%BB%E5%B0%8F%E8%A6%8F%E6%A8%A1%E3%83%81%E3%83%BC%E3%83%A0%E3%81%AB%E5%90%91%E3%81%84%E3%81%A6%E3%81%84%E3%82%8B%E7%90%86%E7%94%B1">🏗️ GitHub Projects が OSS・小規模チームに向いている理由</a></li>
...
<li><a href="#-%E3%81%93%E3%82%93%E3%81%AA%E3%83%81%E3%83%BC%E3%83%A0%E3%83%BB%E3%83%97%E3%83%AD%E3%82%B8%E3%82%A7%E3%82%AF%E3%83%88%E3%81%AB%E3%81%8A%E3%81%99%E3%81%99%E3%82%81">🎯 こんなチーム・プロジェクトにおすすめ</a></li>
...
→ [Workflow ④ Issue Label 一括作成](../workflows/04-setup-repository-labels.md)
→ [Workflow ⑦ Issue/PR 一括紐付け](../workflows/07-add-items-to-project.md)
...
3. **Workflow ⑤** で README・CONTRIBUTING 等の初期ファイルを一括作成
4. **Workflow ⑥** で Branch Protection の Ruleset を一括設定
5. **Workflow ⑦** で既存 Issue/PR を Project に一括紐付け
6. Board View で未トリアージの Issue を一覧化し、週次でチェック
...
2. **Workflow ⑤** で各 Repository に初期ファイル（README・CONTRIBUTING 等）を一括作成
3. **Workflow ⑥** で Branch Protection の Ruleset を一括設定し、コード品質を担保
4. **Workflow ⑦** で 2 Repositories の Issue を Project に一括追加
5. Sprint Board View でタスクの進捗を管理し、Daily で確認
6. Sprint 終了時に **Workflow ⑧** でサマリーレポート・ベロシティレポートを生成し、振り返りに活用
...
| 初期ファイルを一括作成 | [Workflow ⑤ 初期ファイル一括作成](../workflows/05-setup-repository-files.md) |
| Ruleset を一括設定 | [Workflow ⑥ Ruleset 一括作成](../workflows/06-setup-repository-rulesets.md) |
| Issue/PR を Project に紐付け | [Workflow ⑦ Issue/PR 一括紐付け](../workflows/07-add-items-to-project.md) |
| 進捗分析・レポート生成 | [Workflow ⑧ 統合 Project 分析](../workflows/08-analyze-project.md) |
