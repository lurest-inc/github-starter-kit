...
**GitHub Projects Ops Kit** は、上記 1〜4 のすべてを **7 つの Workflow** で自動化します。
...
7 つの Workflow で、セットアップから分析まで一気通貫で実行できます。
...
<details>
<summary>⑤ Community Health Files 一括登録</summary>

- 指定 Repository に Community Health Files を一括セットアップ
- CODE_OF_CONDUCT、CONTRIBUTING、SECURITY、SUPPORT 等を自動配置
...
├── .github/workflows/          # 7 つの自動化 Workflow
